...
const styles = StyleSheet.create({
  ...
  form: { width: '100%' },
  input: { backgroundColor: COLORS.surface, padding: 18, borderRadius: 12, color: COLORS.textPrimary, marginBottom: 15, borderWidth: 1, borderColor: '#E0E0E0', fontSize: 16 },
  passwordContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.surface, borderRadius: 12, marginBottom: 15, borderWidth: 1, borderColor: '#E0E0E0', paddingRight: 15 },
